	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'json',
				default: '{}',
				description: 'Multilingual associations as JSON object mapping language codes to category IDs. Do NOT include the category\'s own language. Example: for an en-GB category, use {"nl-NL": 456, "fr-FR": 789}',
			},
		],
	},
	{
